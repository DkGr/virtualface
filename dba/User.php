...
class User {
	...
	{
            if ($this->VirtualIDDB->Users->findOne(array('infos.username' => $newuser->{'infos'}->{'username'}))) {
                return false;
            }
            $userInfos = array('infos' => (object)array(
                                    'username' => $newuser->{'infos'}->{'username'},
                                    'displayname' => $newuser->{'infos'}->{'displayname'},
                                    'email' => $newuser->{'infos'}->{'email'},
                                    'password' => $newuser->{'infos'}->{'password'}
                                ),
                                'fb-link' => false,
                                'fb-id' => 0,
                                'friends' => array(),
